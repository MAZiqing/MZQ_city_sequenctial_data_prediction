...
class Trainer(object):
    def __init__(self, batch_size=args.batch_size):
        ...
        if args.version == 'v3':
            ...
            self.model = my_model.DS_RNN_III(input_size, output_size, output_column, args)
            # self.model = my_model.STAttention_notf_v5(input_size, output_size, output_column, args)
            ...
            self.model = my_model.DSTP_RNN(input_size, output_size, output_column, args)
        elif args.version == 'v10':
            self.model = my_model.DSTP_RNN_II(input_size, output_size, output_column, args)
